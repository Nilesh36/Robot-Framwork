...
Resource    ../Resources/PO/Rename_File_Folder.robot
Resource    ../Resources/PO/E-SignatureSettings.robot
Resource    ../Resources/PO/PortalNewSendEmailWorkflow.robot
Resource    ../Resources/PO/Create_Instruction.robot
Resource    ../Resources/PO/GmailInbox.robot
...
TC_050_A company settings - E Signature settings
     ...
     Delete the data(Folders)
#
TC_051_Adding reminders to send e-mail element
     ...
     Navigate to tabs    Portals
     ${PortalName}    Create a Client group
     Add Recipient    rahul.sharma1@mailinator.com
     Open Workflow Page
...
TC_052_Verify the user is able to edit a contact
...
TC_053_Canaccord - Create Instruction as an Adviser

    [Tags]    ${TagName}
    [Teardown]  run keyword if test passed    close browser
    run keyword if    ${Browser=='chrome'}    Launch browser    https://canaccord-staging.mydocsafe.com/signin    ${Browser}    ELSE IF    ${Browser=='headlesschrome'}    Launch browser Headless    https://canaccord-staging.mydocsafe.com/signin$%7BEnvironment%7D
    Login with valid credentials    general.mydocsafe.test+1@gmail.com    General-12345-test
    Go To Home Page
    Switch company
    ...
    Close Browser
    run keyword if    ${Browser=='chrome'}    Launch browser    https://canaccord-staging.mydocsafe.com/signin    ${Browser}    ELSE IF    ${Browser=='headlesschrome'}    Launch browser Headless    https://canaccord-staging.mydocsafe.com/signin$%7BEnvironment%7D
    Login with valid credentials    general.mydocsafe.test+2@gmail.com    General-12345-test
    Navigate to tabs    Signatures
    Sign document on second account
    Sign first document
    Submit Document
    Close Browser
    Login into gmail account    ${Browser=='chrome'}    general.mydocsafe.test@gmail.com    General-12345-test

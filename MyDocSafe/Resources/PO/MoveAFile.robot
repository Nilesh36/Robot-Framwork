...
Click Document Upload Button
    ...
    wait until element is enabled    ${DocumentUploadButton}  45s
    sleep    1s
...
Sort by Date
    ...
    wait until element is enabled    ${Created}    45s
    sleep    1s
...
Choose Document    [Arguments]    ${FILENAME}
    ...
    wait until element is enabled    ${ChooseDocumentButton}  45s    #Wait for Upload new file button
...
Click Add a Folder button
    ...
    wait until element is enabled    ${AddAFolderButton}  45s

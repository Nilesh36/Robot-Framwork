...
Restore File or folder    [Arguments]    ${FileorFolderName}
    ...
    sleep    10s
    wait until element is enabled    //p[contains(text(), '${FileorFolderName}')]//parent::div//parent::div//parent::div/div[2]/button    45s
    ...
    sleep    1s
    wait until element is enabled    ${RestoreButton}    45s

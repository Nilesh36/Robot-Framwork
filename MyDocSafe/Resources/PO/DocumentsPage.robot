...
Click plus button from documents window
    ...
    wait until element is enabled    ${PlusbuttonDocuments}    45s    #Wait for plus button
    click element    ${PlusbuttonDocuments}    #Click Plus button

Click New folder

    wait until element is enabled    ${Newfolderbutton}  45s    #Wait for new folder button
    sleep    1s

...
Return to your Documents
    ...
    Wait Until Element Is Visible    ${Return_button}  45s
...
Go to the send Menu
    ...
    Wait Until Element Is Visible   ${Sent_Button}  45s
...
Search box
    ...
    Wait Until Element Is Visible    ${Search_Box}  45s
...
Change signee in the document
        ...
        Wait Until Element Is Visible    ${Change_Icon}  45s

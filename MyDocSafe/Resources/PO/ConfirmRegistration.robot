...
Click Next Button_CR
    ...
    sleep    2s
    wait until element is enabled    ${NextButton_CR}  45s
    click element    ${NextButton_CR}
    sleep    3s
    wait until element is enabled    ${NextButton_CR02}`  45s
...
Click Take me to mydocsafe button
    ...
    wait until element is enabled    ${TakeMeToMydocsafeButton}  45s
    click element    ${TakeMeToMydocsafeButton}

Home Page_free trial

    Sleep    2s
    wait until element is enabled    ${HomePage}  45s

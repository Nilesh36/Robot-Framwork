...
Delete Portal Group    [Arguments]    ${PortalName}
    ...
    wait until element is enabled    //button[contains(@aria-label, '${PortalName}')]//parent::div/div[2]/md-menu/button  45s
    ...
    wait until element is enabled    (//span[text() = 'Settings']//parent::translate//parent::button)[${count}]  45s
    sleep    2s
    click element    (//span[text() = 'Settings']//parent::translate//parent::button)[${count}]
    wait until element is enabled    ${OtherActions}  45s
    sleep    2s
    click element    ${OtherActions}
    wait until element is enabled    ${DeletePortalGroup}  45s
    sleep    2s

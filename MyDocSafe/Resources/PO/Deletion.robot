...
Click Options button
    ...
    wait until element is enabled    ${OptionsButton}    45s
    sleep    2s
    double click element    ${OptionsButton}

Click Delete Button

    wait until element is enabled    ${DeleteButton}  45s
    sleep    1s
    click element    ${DeleteButton}

Select 'Delete This File' in the popup

    wait until element is enabled    ${DeleteThisFileButton}  45s
    click element    ${DeleteThisFileButton}

Select 'Delete This folder' in the popup

    wait until element is enabled    ${DeleteTheFolderButton}  45s
    click element    ${DeleteTheFolderButton}

Select all the folders

    wait until element is enabled    ${AllfoldersCheckbox}  45s
...
Click Trash Icon
    ...
    Sleep    3s
    wait until element is enabled    ${Trashicon}  45s
...
Confirm deletion
    ...
    wait until element is enabled    ${YesDeleteThisFilebutton}  45s

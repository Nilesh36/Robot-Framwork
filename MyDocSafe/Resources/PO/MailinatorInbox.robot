...
Open Registration Email
    ...
    wait until element is enabled    //td[contains(text(), 'Account Invitation')]    45s
    click element    //td[contains(text(), 'Account Invitation')]
    sleep    2s

Open Proposal Email

    wait until element is enabled    //td[contains(text(), 'New proposal')]    45s
...
Accept folder invite
    ...
    wait until element is enabled    //iframe[@id = 'html_msg_body']  45s
    select frame    //iframe[@id = 'html_msg_body']
    wait until element is enabled    //a[text() = 'Accept invitation']//parent::td  45s

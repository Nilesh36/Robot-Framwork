...
Click Three Dot Button
     ...
     wait until element is enabled    ${ThreeDotOptionsButton}  45s
     sleep    1s
...
Click Create static Template button
     ...
     wait until element is enabled    ${CreateStaticTemplateButton}  45s
     click element    ${CreateStaticTemplateButton}

Click Next Button

     wait until element is enabled    ${NextButton}  45s
     sleep    1s
...
Click Save Template Button
     ...
     wait until element is enabled    ${SaveTemplateButton}  45s
     click element    ${SaveTemplateButton}
     wait until element is enabled    //p[contains(text(), '01_DOC.tpl')]  45s

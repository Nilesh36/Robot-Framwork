...
Navigate to tabs    [Arguments]    ${Tabname}
    ...
    wait until element is enabled    //span[text() = '${Tabname}']//parent::translate//parent::span//parent::button  45s    #Wait for Portals tab
    sleep    2s
...
Navigate to Side Pane    [Arguments]    ${PaneName}
    ...
    sleep    10s
    wait until element is visible    //span[text() = '${PaneName}']//parent::span//parent::div  45s
    sleep    2s
